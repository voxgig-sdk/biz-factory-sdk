...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/biz-factory` | `npm install @voxgig-sdk/biz-factory` |
| Python | `voxgig-sdk-biz-factory` | `pip install voxgig-sdk-biz-factory` |
| PHP | `voxgig-sdk/biz-factory` | `composer require voxgig-sdk/biz-factory` |
| Golang | `github.com/voxgig-sdk/biz-factory-sdk/go` | `go get github.com/voxgig-sdk/biz-factory-sdk/go` |
| Ruby | `voxgig-sdk-biz-factory` | `gem install voxgig-sdk-biz-factory` |
| Lua | `voxgig-sdk-biz-factory` | `luarocks install voxgig-sdk-biz-factory` |
