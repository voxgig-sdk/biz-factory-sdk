...
BIZ FACTORY is a Telegram group dedicated to sharing paid methods, APIs, tricks, scripts, and coding resources.

Learn more about BIZ FACTORY at [t.me/+NaATB64x9z4zNTZl](https://t.me/+NaATB64x9z4zNTZl).

This is an unofficial SDK for the BIZ FACTORY public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Group — that you
...
// groups is an array of Group entities, populated with mock data
// — call groups[0].data() for the record itself
console.log(groups)
```
...
```go
client := sdk.Test()
result, err := client.Group(nil).List(
    nil, nil,
)
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/biz-factory-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/biz-factory-sdk/releases) |
| Python | `voxgig-sdk-biz-factory` | publish pending — [install from git tag](https://github.com/voxgig-sdk/biz-factory-sdk/releases) |
| PHP | `voxgig-sdk/biz-factory` | publish pending — [install from git tag](https://github.com/voxgig-sdk/biz-factory-sdk/releases) |
| Golang | `github.com/voxgig-sdk/biz-factory-sdk/go` | `go get github.com/voxgig-sdk/biz-factory-sdk/go@latest` |
| Ruby | `voxgig-sdk-biz-factory` | publish pending — [install from git tag](https://github.com/voxgig-sdk/biz-factory-sdk/releases) |
| Lua | `voxgig-sdk-biz-factory` | publish pending — [install from git tag](https://github.com/voxgig-sdk/biz-factory-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/biz-factory-sdk/go-cli` | `go install github.com/voxgig-sdk/biz-factory-sdk/go-cli/cmd/biz-factory@latest` |
| Go MCP server | `github.com/voxgig-sdk/biz-factory-sdk/go-mcp` | `go get github.com/voxgig-sdk/biz-factory-sdk/go-mcp@latest` |
...
// List all groups (returns GroupEntity[] — .data() for the record)
const groups = await client.Group().list()
...
| --- | --- | --- |
| **Group** | The Group entity (list). | `/group/info` |
...
$groups = $client->Group()->list();
print_r(array_map(fn($item) => $item->data_get(), $groups));
```
...
- Upstream API: [https://t.me/+NaATB64x9z4zNTZl](https://t.me/+NaATB64x9z4zNTZl)
