# BizFactory Ruby SDK Reference

Complete API reference for the BizFactory Ruby SDK.
...
```ruby
require_relative 'biz-factory_sdk'
...
#### `BizFactorySDK.test(testopts = nil, sdkopts = nil)`
