...
// BizFactory SDK utility: graphql
//
...
class BizFactoryGraphql
{
    ...
    // equivalent.
    public static function body(BizFactoryContext $ctx): mixed
    {
    ...
    public static function errors(BizFactoryContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
