...
// BizFactory SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BizFactorySDK::test)
...
{
    private const SDK_CLASS = 'BizFactorySDK';
    ...
    private const SDK_BASE = 'bizfactory_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../bizfactory_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
