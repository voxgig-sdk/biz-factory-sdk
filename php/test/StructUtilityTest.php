...
// BizFactory SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BizFactoryOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BizFactoryOmni::structfix($now, Struct::undef()))
                        !== json_encode(BizFactoryOmni::structfix($val, Struct::undef()))) {
