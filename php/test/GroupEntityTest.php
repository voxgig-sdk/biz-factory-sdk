...
class GroupEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = BizFactorySDK::test($seed, null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BIZ_FACTORY_TEST_GROUP_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function group_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BIZ_FACTORY_TEST_GROUP_ENTID");
    ...
    if ($env["BIZ_FACTORY_TEST_LIVE"] === "TRUE") {
        ...
        $client = new BizFactorySDK(Helpers::to_map($merged_opts));
    }
