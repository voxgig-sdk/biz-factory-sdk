...
class BizFactoryTestRunner
{
    ...
    {
        $live = self::getenv('BIZ_FACTORY_TEST_LIVE');
        $override = self::getenv('BIZ_FACTORY_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BIZ_FACTORY_TEST_EXPLAIN');
...
class_alias('BizFactoryTestRunner', 'Runner');
class_alias('BizFactoryHelpers', 'Helpers');
