# BizFactory PHP SDK Reference

Complete API reference for the BizFactory PHP SDK.
...
```php
require_once __DIR__ . '/biz-factory_sdk.php';
...
#### `BizFactorySDK::test($testopts = null, $sdkopts = null)`
