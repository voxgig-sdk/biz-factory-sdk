...
// BizFactory SDK telemetry feature
...
class BizFactoryTelemetryFeature extends BizFactoryBaseFeature
{
    ...
    private function _close(BizFactoryContext $ctx, bool $ok): void
    {
