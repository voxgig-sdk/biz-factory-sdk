...
// BizFactory SDK streaming feature
...
class BizFactoryStreamingFeature extends BizFactoryBaseFeature
{
    ...
    private function _iterate(BizFactoryResult $result): \Generator
    {
    ...
    private function _streamable(BizFactoryContext $ctx): bool
    {
