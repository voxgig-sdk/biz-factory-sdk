...
class BizFactoryRbacFeature extends BizFactoryBaseFeature
{
    ...
    private function _required(BizFactoryContext $ctx): ?string
    {
    ...
    private function _reject(BizFactoryContext $ctx, string $required): void
    {
    ...
    private function _track(BizFactoryContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
