...
class BizFactoryProxyFeature extends BizFactoryBaseFeature
{
    ...
    public function init(BizFactoryContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BizFactoryContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
