...
// BizFactory SDK ratelimit feature
...
class BizFactoryRatelimitFeature extends BizFactoryBaseFeature
{
    ...
    private function _acquire(BizFactoryContext $ctx): void
    {
    ...
    private function _track(BizFactoryContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
