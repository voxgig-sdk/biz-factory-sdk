...
class BizFactoryCacheFeature extends BizFactoryBaseFeature
{
    ...
    private function _through(BizFactoryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
