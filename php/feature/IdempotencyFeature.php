...
// BizFactory SDK idempotency feature
...
class BizFactoryIdempotencyFeature extends BizFactoryBaseFeature
{
    ...
    private function _mutating(BizFactoryContext $ctx): bool
    {
