...
// BizFactory SDK clienttrack feature
...
class BizFactoryClienttrackFeature extends BizFactoryBaseFeature
{
    ...
    public function PostConstruct(BizFactoryContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BizFactory-SDK';
