...
// BizFactory SDK timeout feature
...
class BizFactoryTimeoutFeature extends BizFactoryBaseFeature
{
    ...
    private function _with_timeout(BizFactoryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BizFactoryContext $_ctx, float $ms): void
    {
        $client = $this->client;
