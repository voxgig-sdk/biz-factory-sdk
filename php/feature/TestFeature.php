...
// BizFactory SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BizFactoryTestFeature extends BizFactoryBaseFeature
{
    ...
    public function init(BizFactoryContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BizFactoryContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = BizFactoryParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BizFactoryContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BizFactoryContext $ctx, $op, $args): array
    {
