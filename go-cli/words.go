...
func registerSDKWords(r *eng.Registry, client *sdk.BizFactorySDK) {
...
func runOp(client *sdk.BizFactorySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
