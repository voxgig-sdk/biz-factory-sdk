# BizFactory TypeScript SDK Reference

Complete API reference for the BizFactory TypeScript SDK.
...
```ts
new BizFactorySDK(options?: object)
```
...
#### `BizFactorySDK.test(testopts?, sdkopts?)`
...
**Returns:** `BizFactorySDK` instance in test mode.
...
Return the parent `BizFactorySDK` instance.
