...
function envOverride(m) {
    if ('TRUE' === process.env.BIZ_FACTORY_TEST_LIVE ||
        'TRUE' === process.env.BIZ_FACTORY_TEST_OVERRIDE) {
    ...
    m.BIZ_FACTORY_TEST_EXPLAIN = process.env.BIZ_FACTORY_TEST_EXPLAIN || m.BIZ_FACTORY_TEST_EXPLAIN;
    return m;
}
