...
(0, node_test_1.describe)('GroupDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('BIZ_FACTORY_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BizFactorySDK({
...
function liveScenariosActive() { return false && process.env.BIZ_FACTORY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BizFactorySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['BIZ_FACTORY_TEST_GROUP_ENTID'];
    ...
    const client = new __1.BizFactorySDK({
        base: 'http://localhost:8080',
