...
(0, node_test_1.describe)('GroupEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.BizFactorySDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set BIZ_FACTORY_TEST_GROUP_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let client = __1.BizFactorySDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['BIZ_FACTORY_TEST_GROUP_ENTID'];
    ...
    if (live) {
        client = new __1.BizFactorySDK(merge([
