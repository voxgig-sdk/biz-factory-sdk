# BizFactory TypeScript SDK



The TypeScript SDK for the BizFactory API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Group()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `BizFactorySDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `BizFactorySDK.test(testopts?, sdkopts?)` | `BizFactorySDK` | Create a test-mode client. |
...
| `client` | `client(): BizFactorySDK` | Return the parent SDK client. |
...
biz-factory/
├── src/
│   ├── BizFactorySDK.ts        # Main SDK class
