...
|---|---|---|
| `ts/` | @voxgig-sdk/biz-factory-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/biz-factory-sdk \
      --repository voxgig-sdk/biz-factory-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/biz-factory-sdk` shows it, and
`npm trust revoke @voxgig-sdk/biz-factory-sdk --id=<id>` removes it.
