...
// BizFactory SDK utility: fetcher

class BizFactoryFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BizFactorySDK/1.0)';
    ...
    public static function call(BizFactoryContext $ctx, string $fullurl, array $fetchdef): array
    {
