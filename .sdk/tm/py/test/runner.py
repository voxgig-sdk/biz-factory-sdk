...
class BizFactoryTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BizFactoryTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = BizFactoryTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = BizFactoryTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
