...
class BizFactoryTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BizFactoryTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = BizFactoryTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = BizFactoryTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
