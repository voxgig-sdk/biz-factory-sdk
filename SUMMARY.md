...
Results: Successful response with group information.
...
| --- | --- | --- | --- |
| Group | `list` | `GET /group/info` | See reference |

## Connect to the API

- Telegram API Server: `https://api.telegram.org`
...
- `biz-factory_list`: List records for an entity. Supported entities: `group`.
- `biz-factory_load`: Load one record for an entity. No active entity supports this operation.
