...
from bizfactory_sdk.core.helpers import get_ctx_prop, to_map
...
class BizFactoryContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, BizFactorySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BizFactoryResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BizFactoryResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BizFactoryError(code, msg, self)
