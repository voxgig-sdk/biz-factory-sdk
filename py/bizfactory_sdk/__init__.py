...
from bizfactory_sdk.utility import register

# Load features
from bizfactory_sdk.feature.base_feature import BizFactoryBaseFeature
from bizfactory_sdk.features import _has_feature, _make_feature
...
class BizFactorySDK:
    ...
    def get_utility(self):
        return BizFactoryUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BizFactorySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Group(self, data=None) -> "GroupEntity":
        ...
        from bizfactory_sdk.entity.group_entity import GroupEntity
