...
from bizfactory_sdk.utility.voxgig_struct import voxgig_struct as vs
from bizfactory_sdk import BizFactorySDK
from bizfactory_sdk.core.spec import BizFactorySpec
from bizfactory_sdk.core.result import BizFactoryResult
from bizfactory_sdk.core.response import BizFactoryResponse
from bizfactory_sdk.core.operation import BizFactoryOperation
from bizfactory_sdk.core.error import BizFactoryError
from bizfactory_sdk.core import helpers
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return BizFactoryError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = BizFactorySDK.test(None, None)
        ...
        class TestInitFeature(BizFactoryBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BizFactoryBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BizFactorySpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BizFactorySDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BizFactorySDK.test(None, setup_opts)
