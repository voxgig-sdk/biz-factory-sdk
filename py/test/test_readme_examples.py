# BizFactory SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BizFactorySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BizFactorySDK(...) and BizFactorySDK.test(...) become
#      BizFactorySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bizfactory_sdk"
_SDK_CLASS = "BizFactorySDK"
