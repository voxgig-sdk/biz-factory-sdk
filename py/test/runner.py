...
class BizFactoryTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BizFactoryTestRunner.getenv("BIZFACTORY_TEST_LIVE")
        override = BizFactoryTestRunner.getenv("BIZFACTORY_TEST_OVERRIDE")
        ...
        explain = BizFactoryTestRunner.getenv("BIZFACTORY_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["BIZFACTORY_TEST_EXPLAIN"] = explain
