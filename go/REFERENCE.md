# BizFactory Golang SDK Reference

Complete API reference for the BizFactory Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *BizFactorySDK`
...
#### `Group(data map[string]any) BizFactoryEntity`
