...
func (sdk *BizFactorySDK) OptionsMap() map[string]any {
...
func (sdk *BizFactorySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BizFactorySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BizFactorySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BizFactorySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BizFactorySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BizFactorySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BizFactorySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BizFactorySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BizFactorySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BizFactorySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
