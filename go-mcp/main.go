// Command BizFactory-mcp is an MCP server exposing the BizFactory
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BizFactory_list  — list records of an entity
//	BizFactory_load  — load a single record of an entity
//
