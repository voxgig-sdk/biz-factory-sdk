...
type Args struct {
	Entity string         `json:"entity" jsonschema:"group"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BizFactorySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "biz-factory_list",
		Description: "List records from BizFactory. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "biz-factory_load",
		Description: "Load a single record from BizFactory. " +
...
func runOp(client *sdk.BizFactorySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BizFactorySDK, name string) (sdk.BizFactoryEntity, error) {
