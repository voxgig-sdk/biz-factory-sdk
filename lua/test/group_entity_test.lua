...
describe("GroupEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BIZ_FACTORY_TEST_GROUP_ENTID JSON to run live")
      return
    end
...
function group_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BIZ_FACTORY_TEST_GROUP_ENTID")
  ...
  if env["BIZ_FACTORY_TEST_LIVE"] == "TRUE" then
