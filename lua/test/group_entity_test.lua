...
describe("GroupEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BIZFACTORY_TEST_GROUP_ENTID JSON to run live")
      return
    end
...
function group_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BIZFACTORY_TEST_GROUP_ENTID")
